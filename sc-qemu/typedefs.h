...
typedef void (*sc_qemu_qdev_gpio_cb_fn)(sc_qemu_qdev *dev, int n, int level, void *opaque);
typedef void (*sc_qemu_qdev_gpio_register_cb_fn)(sc_qemu_qdev *dev, int gpio_idx,
                                                 sc_qemu_qdev_gpio_cb_fn fn, void *opaque);
